...
<template>
    ...
    <AdminLayout>
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <h1 class="text-2xl font-bold text-[#111]">Add New Category</h1>
            </div>
        ...
        <div class="bg-white border border-gray-200 rounded-lg p-6 max-w-2xl">
            <form @submit.prevent="submit" class="space-y-5">
                <div>
                    ...
                    <input v-model="form.name" type="text" required placeholder="e.g. Laptops"
                ...
                <div>
                    ...
                    <p class="text-[11px] text-gray-400 mt-1">Select a parent if this is a subcategory.</p>
                </div>

                <div>
                    <label class="text-[13px] font-bold text-gray-700 mb-1.5 block">FontAwesome Icon Class</label>
                    <input v-model="form.icon" type="text" placeholder="e.g. fas fa-laptop"
                        class="w-full border border-gray-300 rounded py-2.5 px-3 text-[14px] focus:border-ryans focus:ring-ryans bg-gray-50 focus:bg-white transition">
                ...
                <div class="pt-4 border-t border-gray-100 flex justify-end">
                    <button type="submit" :disabled="form.processing"
                        ...
                        <i v-if="form.processing" class="fas fa-spinner fa-spin mr-2"></i> Save Category
                    </button>
                </div>
            </form>
        </div>
