...
<template>
    ...
    <AdminLayout>
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <h1 class="text-2xl font-bold text-[#111]">Edit Brand</h1>
                <p class="text-[13px] text-gray-500 mt-1 font-medium">{{ brand.name }}</p>
            </div>
            ...
            <form @submit.prevent="submit" class="space-y-5">
                ...
                <div class="pt-4 border-t border-gray-100 flex justify-end">
                    <button type="submit" :disabled="form.processing"
                        ...
                        <i v-if="form.processing" class="fas fa-spinner fa-spin mr-2"></i> Update Brand
                    </button>
                </div>
            </form>
        </div>
